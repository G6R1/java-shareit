...
public class ItemRequestClient {
    ...
    public ItemRequestDto createItemRequest(ItemRequestDto itemRequestDto, Long requetorId) {
        return client.post()
    ...
    public ItemRequestDto getItemRequest(Long requestId, Long requetorId) {
